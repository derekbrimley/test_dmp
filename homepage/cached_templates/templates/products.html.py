...
_magic_number = 10
_modified_time = 1425398382.718288
_enable_loop = True
...
def render_content(context,**pageargs):
    ...
    try:
        ...
        for product in products:
            ...
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.serial_number))
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.date_acquired))
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.cost))
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.status))
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.for_sale))
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.is_rentable))
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.notes))
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.times_rented))
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.price_per_day))
            __M_writer('</td>\r\n\t\t\t\t<td>')
            __M_writer(str(product.replacement_price))
            __M_writer('</td>\r\n')
            if request.user.has_perm('homepage.is_manager'):
...
"""
__M_BEGIN_METADATA
{"source_encoding": "ascii", "line_map": {"27": 0, "36": 1, "46": 3, "54": 3, "55": 21, "56": 22, "57": 24, "58": 25, "59": 26, "60": 27, "61": 27, "62": 28, "63": 28, "64": 29, "65": 29, "66": 30, "67": 30, "68": 31, "69": 31, "70": 32, "71": 32, "72": 33, "73": 33, "74": 34, "75": 34, "76": 35, "77": 35, "78": 36, "79": 36, "80": 37, "81": 37, "82": 38, "83": 38, "84": 39, "85": 39, "86": 40, "87": 40, "88": 41, "89": 42, "90": 43, "91": 43, "92": 45, "93": 45, "94": 48, "95": 50, "96": 51, "97": 52, "103": 97}, "uri": "products.html", "filename": "C:\\Users\\Derek\\python\\test_dmp\\homepage\\templates/products.html"}
__M_END_METADATA
"""
